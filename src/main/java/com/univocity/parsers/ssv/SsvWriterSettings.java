...
/**
 * This is the configuration class used by the TSV writer ({@link SsvWriter})
 *
...
public class SsvWriterSettings extends CommonWriterSettings<SsvFormat> {
	 ...
	 * the escape character (defined by {@link SsvFormat#getEscapeChar()} followed by the actual line separator character
	 * instead of other characters such as the standard letters 'n' and 'r'
	 *
	 * When line joining is disabled (the default), the {@link SsvWriter} will convert new line characters into
	 ...
	 *
	 * If line joining is enabled, the {@link SsvWriter} will convert line new line characters into sequences
