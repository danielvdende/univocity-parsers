...
/**
 * This is the configuration class used by the CSV writer ({@link SsvWriter})
 *
 ...
 * <p>If this property is set to true, this indicates that all written values should be enclosed within quotes (as defined in {@link SsvFormat})</li>
 * </ul>
 *
 ...
 */
public class SsvWriterSettings extends CommonWriterSettings<SsvFormat> {
	...
	/**
	 * Indicates that all written values should be enclosed within quotes (as defined in {@link SsvFormat})
	 * <p> (Defaults to false)
	 *
	...
	/**
	 * Indicates indicates whether or not all written values should be enclosed within quotes (as defined in {@link SsvFormat})
	 *
	 * <p> (Defaults to false)
	...
	@Override
	public final SsvWriterSettings clone() {
		return (SsvWriterSettings) super.clone();
	}

	@Override
	public final SsvWriterSettings clone(boolean clearInputSpecificSettings) {
		return (SsvWriterSettings) super.clone(clearInputSpecificSettings);
	}
}
