...
// TODO: docs/comments
/**
 * This is the configuration class used by the CSV parser ({@link SsvParser})
 *
...
public class SsvParserSettings extends CommonParserSettings<SsvFormat> {
	 ...
	 * <p>Note that the detection process is not guaranteed to discover the correct column delimiter. In this case the delimiter provided by {@link SsvFormat#getDelimiter()} will be used</p>
	 *
	 ...
	 * In this case the characters provided by {@link SsvFormat#getQuote()} and {@link SsvFormat#getQuoteEscape()} will be used </p>
	 *
